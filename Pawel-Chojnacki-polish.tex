...
\cventry{}{}{}{}{Inżynier oprogramowania z 4-letnim stażem pracy. W British Council pracuję .NET Developer w dziesięcioosobowym zespole. Zajmuje się utrzymaniem i rozwojem funkcjonalności w aplikacji webowej 'Schools'. Jest to system rejestracji na egzaminy, zarządzanie setkami szkół i centrów. Pracuje w SCRUMie, co daje mi możliwość doboru zadań w szerokim zakresie technologicznym. W British Council mam okazję praktykować Domain Driven Design. Swój dalszy rozwój planuje w kierunku architektury aplikacji webowych opartych o .NET Core. Wcześniej pracując w BSB zwiększyłem wydajność aplikacji bazodanowej o 1200\% oraz modernizowałem aplikację z Silverlight'a do ASP.NET MVC. Regularnie uczestniczę w szkoleniach technicznych (edX, Coursera, Pluralsight) o programowaniu, a także architekturze i inżynierii oprogramowania.}{}
...
\cventry{\textsc{Visual Studio}}{}{}{}{Wszystkie wersje Visual Studio 2008 -- 2017 (z dodatkiem ReSharper), Code, VS for Mac}{}
